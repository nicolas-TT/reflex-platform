...
rec {
  ...
  combined = self: super: foldExtensions [
    ...
    (optionalExtension (with nixpkgs.stdenv; versionWildcard [ 9 12 ] super.ghc.version && !(super.ghc.isGhcjs or false) && hostPlatform != buildPlatform) loadSplices-9_12)
  ...
  loadSplices-9_12 = import ./splices-load-save/load-splices.nix {
    inherit lib haskellLib fetchFromGitHub;
    isExternalPlugin = true;
    splicedHaskellPackages = ghcSavedSplices-9_12;
  };
